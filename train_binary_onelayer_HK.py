...
learning_rate=0.1, nkerns=[6, 14], filter_size1=(1,7), batch_size=70, kmax=30, dropout=0.2, hidden units=50, L1=0, L2=0.000005, useEmb=1, performance=20.769231%
learning_rate=0.1, nkerns=[6, 14], filter_size1=(1,7), batch_size=50, kmax=30, dropout=0.2, hidden units=50, L1=0, L2=0.000005, useEmb=0, performance=21.513514%
#for new batch start
learning_rate=0.1, nkerns=[6, 14], filter_size1=(1,7), batch_size=50, kmax=30, dropout=0.2, hidden units=50, L1=0, L2=0.000005, useEmb=1, performance=24.054054%
learning_rate=0.1, nkerns=[6, 14], filter_size1=(1,7), batch_size=70, kmax=30, dropout=0.2, hidden units=50, L1=0, L2=0.000005, useEmb=1, performance=20.952381%
learning_rate=0.1, nkerns=[6, 14], filter_size1=(1,7), batch_size=70, kmax=30, dropout=0.8, hidden units=50, L1=0, L2=0.000005, useEmb=1, performance=21.587302%
...
from HKDefined import ConvFoldPoolLayer,Conv_DynamicK_PoolLayer, dropout_from_layer, read_data_HK
